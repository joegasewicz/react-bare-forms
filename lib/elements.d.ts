...
export declare type TypeStyleSize = "small" | "large" | undefined;
 ...
 * @constructor
 */
export declare const QueryInputField: (props: IQueryField) => JSX.Element;
/**
